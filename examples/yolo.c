...
void train_yolo(char *cfgfile, char *weightfile)
{
    ...
    listdn *plist = get_paths(train_images);
    //int N = plist->size;
...
void validate_yolo(char *cfg, char *weights)
{
    ...
    //listdn *plist = get_paths("data/voc.2007.test");
    listdn *plist = get_paths("/home/pjreddie/data/voc/2007_test.txt");
    //listdn *plist = get_paths("data/voc.2012.test");
    char **paths = (char **)list_to_array(plist);
