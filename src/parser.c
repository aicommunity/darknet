...
local_layer parse_local(listdn *options, size_params params)
{
...
layer parse_deconvolutional(listdn *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
convolutional_layer parse_convolutional(listdn *options, size_params params)
{
    int n = option_find_int(options, "filters",1);
    int size = option_find_int(options, "size",1);
    int stride = option_find_int(options, "stride",1);
...
layer parse_crnn(listdn *options, size_params params)
{
...
layer parse_rnn(listdn *options, size_params params)
{
...
layer parse_gru(listdn *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_lstm(listdn *options, size_params params)
{
    int output = option_find_int(options, "output", 1);
    int batch_normalize = option_find_int_quiet(options, "batch_normalize", 0);
...
layer parse_connected(listdn *options, size_params params)
{
    int output = option_find_int(options, "output",1);
    char *activation_s = option_find_str(options, "activation", "logistic");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_softmax(listdn *options, size_params params)
{
    int groups = option_find_int_quiet(options, "groups",1);
...
layer parse_yolo(listdn *options, size_params params)
{
...
layer parse_iseg(listdn *options, size_params params)
{
    int classes = option_find_int(options, "classes", 20);
...
layer parse_region(listdn *options, size_params params)
{
...
detection_layer parse_detection(listdn *options, size_params params)
{
...
cost_layer parse_cost(listdn *options, size_params params)
{
...
crop_layer parse_crop(listdn *options, size_params params)
{
...
layer parse_reorg(listdn *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
maxpool_layer parse_maxpool(listdn *options, size_params params)
{
    int stride = option_find_int(options, "stride",1);
...
avgpool_layer parse_avgpool(listdn *options, size_params params)
{
    int batch,w,h,c;
    w = params.w;
    h = params.h;
...
dropout_layer parse_dropout(listdn *options, size_params params)
{
...
layer parse_normalization(listdn *options, size_params params)
{
...
layer parse_batchnorm(listdn *options, size_params params)
{
    layer l = make_batchnorm_layer(params.batch, params.w, params.h, params.c);
    return l;
}

layer parse_shortcut(listdn *options, size_params params, network *net)
{
...
layer parse_l2norm(listdn *options, size_params params)
{
...
layer parse_logistic(listdn *options, size_params params)
{
...
layer parse_activation(listdn *options, size_params params)
{
    char *activation_s = option_find_str(options, "activation", "linear");
    ACTIVATION activation = get_activation(activation_s);
...
layer parse_upsample(listdn *options, size_params params, network *net)
{
...
route_layer parse_route(listdn *options, size_params params, network *net)
{
...
void parse_net_options(listdn *options, network *net)
{
...
{
    listdn *sections = read_cfg(filename);
